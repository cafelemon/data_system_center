...
DEPARTMENTS = [
    {"name": "董事会办公室", "code": "DSHBGS", "enabled": True, "sort_order": 10},
    {"name": "综合管理部", "code": "ZHGL", "enabled": True, "sort_order": 20},
    {"name": "北京公司", "code": "BJGS", "enabled": True, "sort_order": 30},
    {"name": "投资者关系部", "code": "TZZGX", "enabled": True, "sort_order": 40},
    {"name": "财务与资产管理部", "code": "CWZC", "enabled": True, "sort_order": 50},
    {"name": "组织与人才发展中心", "code": "ZZRC", "enabled": True, "sort_order": 60},
    {"name": "研发中心", "code": "YFZX", "enabled": True, "sort_order": 70},
    {"name": "生产中心", "code": "SCZX", "enabled": True, "sort_order": 80},
    {"name": "客户服务中心", "code": "KHFW", "enabled": True, "sort_order": 90},
    {"name": "数字与信息中心", "code": "SZXX", "enabled": True, "sort_order": 100},
    {"name": "质量体系部", "code": "ZLTX", "enabled": True, "sort_order": 110},
    {"name": "临床与注册事务部", "code": "LCZC", "enabled": True, "sort_order": 120},
    {"name": "工程管理部", "code": "GCGL", "enabled": True, "sort_order": 130},
    {"name": "发展规划部", "code": "FZGH", "enabled": True, "sort_order": 140},
    {"name": "监察审计室", "code": "JCSJ", "enabled": True, "sort_order": 150},
]
...
SCREENSHOT_ARCHIVES = [
    ...
    ("DA-2020-0002", "产品研发技术文档", "科技档案", "已归档", "30年", "研发中心", "2020-02-15", "B区-03柜", "李四"),
    ("DA-2020-0003", "员工入职档案-张三", "人事档案", "已销毁", "10年", "组织与人才发展中心", "2020-03-15", "C区-02柜", "王五"),
    ("DA-2020-0004", "采购合同-办公用品", "财务档案", "待审核", "永久", "财务与资产管理部", "2020-04-15", "D区-05柜", "赵六"),
    ("DA-2020-0005", "会议纪要-2024Q1", "合同档案", "在库", "30年", "董事会办公室", "2020-05-15", "E区-01柜", "钱七"),
    ("DA-2020-0006", "项目验收报告-A项目", "文书档案", "已归档", "10年", "综合管理部", "2020-06-15", "A区-01柜", "张三"),
    ("DA-2020-0007", "专利申请文件", "科技档案", "已销毁", "永久", "研发中心", "2020-07-15", "B区-03柜", "李四"),
    ("DA-2020-0008", "年度审计报告", "人事档案", "待审核", "30年", "监察审计室", "2020-08-15", "C区-02柜", "王五"),
    ("DA-2020-0009", "客户合作协议", "财务档案", "在库", "10年", "客户服务中心", "2020-09-15", "D区-05柜", "赵六"),
    ("DA-2020-0010", "设备采购清单", "合同档案", "已归档", "永久", "工程管理部", "2020-10-15", "E区-01柜", "钱七"),
]
...
def screenshot_archive_values(
    ...
    return {
        ...
        "internal_archive_type": archive_type,
        ...
        "electronic_storage_path": None,
        "archiver_name": owner_name,
...
def generated_archive_values(
    ...
    return {
        ...
        "retention_period_id": lookups["retention_periods"][retention_period].id,
        "department_id": lookups["departments"][department].id,
        "paper_copies": number % 4 + 1,
        "archive_date": archive_date,
        "paper_storage_location": storage_locations[number % len(storage_locations)],
        "electronic_storage_path": None,
        "archiver_name": owners[(number + 1) % len(owners)],
